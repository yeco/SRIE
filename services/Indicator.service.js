...
export default {
   ...
   * @param {number} [educationalLevel] Educational Level id
   */
  search: async (pecGoal, topic, educationalLevel) => {
    const where = getSearchWhere(pecGoal, topic, educationalLevel);
